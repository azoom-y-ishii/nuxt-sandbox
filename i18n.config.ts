export default defineI18nConfig(() => ({
  ...
  messages: {
    ja: {
      zodI18n: {
        errors: {
          invalid_type: '{expected}での入力を期待していますが、{received}が入力されました。',
          ...
          invalid_union_discriminator: '無効な識別子です。{- options}で入力してください。',
          invalid_enum_value: '\'{received}\'は無効な値です。{- options}で入力してください。',
          ...
          invalid_string: {
            ...
            none_free_email: 'フリーアドレスを利用できません。',
          },
          too_small: {
            array: {
            ...
            date: {
              ...
              not_inclusive: '{- minimum, datetime}よりも後の日時である必要があります。',
            },
          },
          too_big: {
            array: {
            ...
            date: {
              ...
              not_inclusive: '{- maximum, datetime}よりも前の日時である必要があります。',
            },
          },
        },
        validations: {
          email: 'メールアドレス',
          none_free_email: 'フリーメールアドレス',
          url: 'URL',
          uuid: 'UUID',
          cuid: 'CUID',
          regex: '正規表現',
